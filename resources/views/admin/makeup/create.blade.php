...
<div class="contianer">
  ...
  <div class="form-group">
    ...
    <input type="Text" value="{{old('style')}}" class="form-control @error('style') is-invalid @enderror" id="style" placeholder="masukan style" name="style">
  </div>
